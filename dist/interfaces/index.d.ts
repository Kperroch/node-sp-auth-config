...
export declare type StrategyCode = 'OnPremiseAddinCredentials' | 'OnpremiseUserCredentials' | 'OnpremiseTmgCredentials' | 'OnpremiseFbaCredentials' | 'OnlineAddinCredentials' | 'OnlineAppCert' | 'UserCredentials' | 'AdfsUserCredentials' | 'OnDemandCredentials';
